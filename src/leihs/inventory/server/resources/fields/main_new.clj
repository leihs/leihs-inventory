(ns leihs.inventory.server.resources.fields.main-new
  (:require
   ...
   [leihs.inventory.server.resources.models.form.license.queries :refer [license-base-query]]
...
(defn get-form-fields-with-new-pagination-handler [request]
...
(defn get-form-fields-new-handler [request]
