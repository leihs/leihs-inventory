...
def expect_audit_entries(expected_auditedrequest_info, expected_auditchange_list, expected_auditedresponse_status, options = {distinct: false, expected_requested_count: 1, expected_response_count: 1})
