(ns leihs.inventory.server.resources.pool.fields.routes
  (:require
   ...
   [leihs.inventory.server.resources.pool.fields.form-fields :refer [get-form-fields-auto-new-pagination-handler]]
   [leihs.inventory.server.resources.pool.fields.main :refer [get-form-fields-handler
                                                         get-form-fields-auto-pagination-handler]]
   [leihs.inventory.server.resources.pool.fields.search :refer [get-search-with-pagination-handler]]
