(ns leihs.inventory.server.resources.pool.models.form.license.model-by-pool-form-create
  (:require
   ...
   [leihs.inventory.server.resources.pool.models.form.license.common :refer [int-to-numeric int-to-numeric-or-nil double-to-numeric-or-zero double-to-numeric-or-nil
   ...
   [leihs.inventory.server.resources.pool.models.helper :refer [str-to-bool normalize-model-data normalize-license-data]]
