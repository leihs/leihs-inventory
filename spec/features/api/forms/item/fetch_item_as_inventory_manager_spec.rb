...
expected_fields = ["serial_number", "properties_mac_address", "properties_imei_number", "name", "note", "attachments",
  "is_inventory_relevant", "owner_id", "last_check", "inventory_pool_id", "responsible", "user_name",
  "properties_reference", "properties_project_number", "invoice_number", "invoice_date", "price",
  "supplier_id", "properties_warranty_expiration", "properties_contract_expiration", "building_id",
  "room_id", "shelf", "inventory_code", "model_id", "retired", "retired_reason", "is_broken",
  "is_incomplete", "is_borrowable", "status_note"]
...
feature "Inventory Item" do
  context "when interacting with inventory item with role=inventory_manager", driver: :selenium_headless do
