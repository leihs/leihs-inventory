      ...
      context "create model with attachments/images/patch (max)" do
        it "creates a model with all available attributes" do
          ...
          images.each do |image|
            content_length = File.size(image.path)
          ...
          images = [path_arrow, path_arrow_thumb]
          ...
          #
          #                                 "X-Filename" => File.basename(image_path)
          #                                   #     "X-Filename" => image.path.split("/").last
          #
          #                                 })
          #
          ...
          #   }
          #
          #   payload = Faraday::UploadIO.new(image_path, "image/png")
          #
          #
          #   # resp = json_client_post(
          #   #   "/inventory/models/#{model_id}/images",
          ...
          #   @image_id = response_body["image"]["id"]
          # end
