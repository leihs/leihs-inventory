                                          ...
                                          ($ CommandList {:data-test-id "users-list"}
                                             ...
                                             (for [element data]
                                               ($ CommandItem {:key (:id element)
                                                               :value (str (:firstname element) " " (:lastname element) " - " (:email element))
                                                               :on-select (fn []
                                                                            (set-open! false)
                                                                            (if
                                                  ...
                                                  ($ :span
                                                     {:class-name (str (when (= 1 (:level element)) " font-bold ")
                                                                       ...
                                                                       " truncate")}
                                                     (str (:firstname element) " " (:lastname element) " - " (:email element)))))))))
                                 ($ FormDescription)
                                 ($ FormMessage))})
                         ...
                         ($ TableCell {:class-name "w-0"}
                            ...
                            (if (:url field)
                              ($ Dialog
                                 ...
                                 ($ DialogContent
                                    ($ DialogHeader
                                       ($ DialogTitle (str (:firstname field) " " (:lastname field) " - " (:email field))))
                                    ($ :img {:src (:url field)
                                             :class-name "w-[50vh] aspect-square object-contain"})))
                              ($ Image {:class-name "w-10 h-10 scale-[1.2]"})))

                         ($ TableCell {:class-name ""}
                            (str (:firstname field) " " (:lastname field) " - " (:email field)))
