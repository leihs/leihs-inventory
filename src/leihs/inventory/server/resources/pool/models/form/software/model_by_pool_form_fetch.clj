(ns leihs.inventory.server.resources.pool.models.form.software.model-by-pool-form-fetch
  (:require
   ...
   [leihs.inventory.server.resources.pool.models.queries :refer [attachments-query]]
