(ns leihs.inventory.client.routes.items.packages.crud.page
  (:require
   ["@/components/react/scrollspy/scrollspy" :refer [Scrollspy ScrollspyItem
                                                     ScrollspyMenu]]
   ["@/routes/items/crud/components/form" :refer [schema structure]]
   ...
   [leihs.inventory.client.routes.items.crud.components.fields :as form-fields]
