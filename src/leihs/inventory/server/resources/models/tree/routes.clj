(ns leihs.inventory.server.resources.models.tree.routes
  (:require
   ...
   ;[leihs.inventory.server.resources.models.tree.tree :as tree]
...
(sa/def :test/with-metadata boolean?) ;; Define the spec for `:with-metadata`
...
```"
           ...
           :parameters {
                        ...
                        :query (sa/keys :opt-un [:test/with-metadata])
                        }
