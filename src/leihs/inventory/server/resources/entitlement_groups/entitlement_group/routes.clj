(ns leihs.inventory.server.resources.entitlement-groups.entitlement-group.routes
  (:require
   [clojure.set]
   [leihs.inventory.server.resources.entitlement-groups.entitlement-group.main :refer [
                                                             get-entitlement-groups-of-pool-handler
                                                             ]]

   [leihs.inventory.server.resources.entitlement-groups.types :refer [response-body]]
