(ns leihs.inventory.server.resources.pool.models.form.license.model-by-pool-form-update
  (:require
   ...
   [leihs.inventory.server.resources.pool.models.form.license.common :refer [parse-local-date-or-nil calculate-retired-value int-to-numeric int-to-numeric-or-nil double-to-numeric-or-zero double-to-numeric-or-nil
