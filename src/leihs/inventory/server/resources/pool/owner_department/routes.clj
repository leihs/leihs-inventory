(ns leihs.inventory.server.resources.pool.owner-department.routes
  (:require
   [clojure.set]
   [leihs.inventory.server.resources.pool.owner-department.main :refer [get-owner-department-of-pool-auto-pagination-handler]]
