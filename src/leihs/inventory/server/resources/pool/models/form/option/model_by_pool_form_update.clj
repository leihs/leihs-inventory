(ns leihs.inventory.server.resources.pool.models.form.option.model-by-pool-form-update
  (:require
   ...
   [leihs.inventory.server.resources.pool.models.form.license.common :refer [double-to-numeric-or-nil]]
